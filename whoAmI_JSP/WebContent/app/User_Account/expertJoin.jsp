...
<link rel="stylesheet"
	href="/css/User_Account/User_Join.css">
<link rel="stylesheet"
	href="/css/User_Account/zipcode.css">
	...
	<div class="encore-light-theme" style="background-color:#f5f6f7;">
		<div class="indexpage__Signup-zyim1e-0 cUBnIY">
			<div class="Header__Container-nt28l4-0 cLyTtM">
				...
				<img src="/app/User_Account/img/logo.png" alt="이미지없음">
				</a>
				<h2
			...
			<form method="post"
				...
				<div class="Group-u9bcx5-0 bXxIjv">
					...
					<input type="email" aria-invalid="false" name="userEmail"
						id="userEmail" placeholder="이메일을 입력하세요." required value
				...
				<div class="Group-u9bcx5-0 bXxIjv">
					...
					<input type="text" aria-invalid="false" name="userName"
						id="userName" placeholder="이름을 입력하세요." required value
						class="Input-sc-1gbx9xe-0 dwAQbF">
					<div
				...
				<div class="Group-u9bcx5-0 bXxIjv">
					...
					<input type="text" aria-invalid="false" name="userHP"
						id="userHP" placeholder="본인 명의의 휴대폰 번호를 입력하세요" required value
						class="Input-sc-1gbx9xe-0 dwAQbF">
					<div
				...
				<div class="Group-u9bcx5-0 bXxIjv">
					...
					<div class="gender">
						<input type="radio" name="userGender" value="여자"
							style="width: 15px; height: 16px;" /> <label
							for="managerconsultText">여자</label> <input type="radio"
							name="userGender" value="남자" style="width: 15px; height: 16px;" />
...
본 약관은 2021년 01월 24일부터 적용하고, 2016년 5월 2일부터 시행되던 종전의 약관은 본 약관으로 대체합니다.
						...
						<div class="Group-u9bcx5-0 bXxIjv">
							<div class="Checkbox-svpvf6-0 iuhOXU">
								<input type="checkbox" id="expertremember" name="expertremember"
			...
			<div class="EmailForm__Center-jwtojv-0 eaexVT">
				<div class="SignupButton__ButtonContainerSignup-cjcq5h-0 gvwzIR">
					<button type="submit" class="Button-qlcn5g-0 kNXVkb">
						<div onclick="ExpertJoinSend()"
							class="ButtonInner-sc-14ud5tc-0 flmFpd encore-bright-accent-set SignupButton___StyledButtonPrimary-cjcq5h-1 gzFCtx" 
							>가입하기</div>
...
<script>var contextPath = "49.50.162.195";</script>
<script src="js/User_Account/expertJoin.js"></script>
