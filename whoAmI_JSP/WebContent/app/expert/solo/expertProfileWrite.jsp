...
<body>
	...
	<section class="management_wrapper_expert">
		...
		<form method="post" action="expert/ExpertProfileWriteOk.me" name="writeForm" enctype="multipart/form-data" class="my update">
			<p>이름을 작성해주세요</p> 
	            ...
	            <div class="files">
	               <div>
	                  <label for="board_file1" style="display:inline;">
	                     <img id="board_file1Img" src="images/expert/solo/첨부파일.png">
	                  </label>
	               </div>
...
<script src="js/expert/solo/expertProfileManagement.js"></script>
</html>