...
<meta charset="UTF-8">
<title>전문가 프로필</title>
<link rel="stylesheet" href="css/expert/solo/expert.css" />
	...
	<div class="wrapper expert">
		...
		<div class="wrapper_self">
			...
			<div	class="expert_profile_img">
				<img src="upload/${profile.getManagerPictureNameOrignal()}" >
			</div>
		</div>
		...
		<div class="wrapper_degree">
			...
			<div class="degree_career_wrapper">
				<div class="career" >
					<div>경력  <img src="images/expert/solo/경력.png"> </div>
					<div class="career_list">${profile.getManagerCareer()}</div>			
				</div>
				<div class="academy">
					<div>학력  <img src="images/expert/solo/학력.png"> </div>
			...
			<div class="consult_intro_right">
				...
				<div class="consult_review_wrapper">
					...
					<div class="review_bar" onclick="plusReview()">
						<div class="plusReviewBtn">더보기</div> <div><img src="images/expert/solo/하단애로우.png"></div>
					</div>
			</div>
		</div>
...
<script src="js/expert/solo/expertProfileDetail.js"></script>
</html>