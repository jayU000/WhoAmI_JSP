		...
		<div class="management_header">
			<ul class="my">
				...
				<input type="button" value="취소"
					onclick="location.href = 'expert/ExpertListCheck.me'">
				</li>
			</ul>
		</div>
		<form method="post" action="expert/ExpertProfleUpdateOk.me" class="my" enctype="multipart/form-data" name="updateForm">
	            ...
	            <div class="files">
	               <div>
	                  <label for="board_file1" style="display:inline;">
	                     <img id="board_file1Img" style="width: 122px; height: 180px" src="upload/${profile.getManagerPictureNameOrignal()}" width="50px" height="50px" style="display:inline;">
	                  </label>
	               </div>
...
<script src="js/expert/solo/profileUpdate.js"></script>
</html>